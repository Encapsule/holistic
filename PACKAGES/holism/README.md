...
# @encapsule/holism v0.0.32 "jeunelanding"

```
Package: @encapsule/holism v0.0.32 "jeunelanding" build ID "LzLWIH_tT2iF4CqIH0RdwQ"
...
- [@encapsule/holism Package Distribution](https://npmjs.com/package/@encapsule/holism/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
