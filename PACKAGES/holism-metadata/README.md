...
# @encapsule/holism-metadata v0.0.32 "jeunelanding"

```
Package: @encapsule/holism-metadata v0.0.32 "jeunelanding" build ID "YF5kiOBrRUeb_lQwRnRuyg"
...
- [@encapsule/holism-metadata Package Distribution](https://npmjs.com/package/@encapsule/holism-metadata/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
