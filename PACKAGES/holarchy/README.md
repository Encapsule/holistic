...
# @encapsule/holarchy v0.0.32 "jeunelanding"

```
Package: @encapsule/holarchy v0.0.32 "jeunelanding" build ID "YF5kiOBrRUeb_lQwRnRuyg"
...
- [@encapsule/holarchy Package Distribution](https://npmjs.com/package/@encapsule/holarchy/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
