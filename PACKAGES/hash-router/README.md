...
# @encapsule/hash-router v0.0.32 "jeunelanding"

```
Package: @encapsule/hash-router v0.0.32 "jeunelanding" build ID "YF5kiOBrRUeb_lQwRnRuyg"
...
- [@encapsule/hash-router Package Distribution](https://npmjs.com/package/@encapsule/hash-router/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
