...
# ![](ASSETS/encapsule-holistic-48x48.png)&nbsp;[Holistic App Platform](../../README.md#encapsule-project "Back to the Holistic App Platform README...") &bull; hash-router
...
```
Package: @encapsule/hash-router v0.0.33 "quatsino" build ID "P8D-x1lWQj2k9n8rhJpeRA"
