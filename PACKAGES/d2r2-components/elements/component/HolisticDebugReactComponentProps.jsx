...
var factoryResponse = reactComponentBindingFilterFactory.create({
  ...
  reactComponent: /*#__PURE__*/function (_React$Component) {
    ...
    var _super = _createSuper(HolisticDebugReactComponentProps);
    ...
    _createClass(HolisticDebugReactComponentProps, [{
      ...
      value: function render() {
        ...
        if (!this.state.showDetails) {
          ...
          var details = [];
          details.push( /*#__PURE__*/React.createElement("div", {
            key: makeKey(),
          ...
          }, /*#__PURE__*/React.createElement("p", null, "To debug a rendering issue with a specific React component, set a breakpoint in its render method (or possibly lifecycle method(s)). Step through your view rendering logic to find errors handling input(s). Check your subcomponent delegations and specific values passed."), /*#__PURE__*/React.createElement("p", null, "To debug page-level layout rendering problems, set a breakpoint in the render method of ", /*#__PURE__*/React.createElement("strong", null, "<ComponentRouter/>"), ". Inspect the React component selected and specific data value(s) bound to the selected component before the call is delegated.")));
          details.push( /*#__PURE__*/React.createElement("p", {
            key: makeKey()
          }, /*#__PURE__*/React.createElement("strong", null, "Click each section title below to toggle JSON view...")));
          details.push( /*#__PURE__*/React.createElement("h3", {
            key: makeKey(),
          ...
          if (this.state.showDocumentData) details.push( /*#__PURE__*/React.createElement("pre", {
            key: makeKey(),
          ...
          if (this.state.showAppDataStore) details.push( /*#__PURE__*/React.createElement("pre", {
            key: makeKey(),
            style: theme.classPRE
          ...
          if (this.state.showMetadataStore) details.push( /*#__PURE__*/React.createElement("pre", {
            key: makeKey(),
            style: theme.classPRE
          ...
          if (this.state.showAppStateController) details.push( /*#__PURE__*/React.createElement("pre", {
            key: makeKey(),
            style: theme.classPRE
