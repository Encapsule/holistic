...
# ![](ASSETS/encapsule-holistic-48x48.png)&nbsp;[Holistic App Platform](../../README.md#encapsule-project "Back to the Holistic App Platform README...") &bull; d2r2-components
...
```
Package: @encapsule/d2r2-components v0.0.33 "quatsino" build ID "P8D-x1lWQj2k9n8rhJpeRA"
