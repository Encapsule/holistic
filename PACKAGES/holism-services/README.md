...
# @encapsule/holism-services v0.0.32 "jeunelanding"

```
Package: @encapsule/holism-services v0.0.32 "jeunelanding" build ID "YF5kiOBrRUeb_lQwRnRuyg"
...
- [@encapsule/holism-services Package Distribution](https://npmjs.com/package/@encapsule/holism-services/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
