...
(function () {
  ...
  var cellmodel = new holarchy.CellModel({
    ...
    actions: [require("./ControllerAction-ObservableValueHelper-configure"), require("./ControllerAction-ObservableValueHelper-get-link-error"), require("./ControllerAction-ObservableValueHelper-read"), require("./ControllerAction-ObservableValueHelper-reset"), require("./ControllerAction-ObservableValueHelper-step-worker")],
