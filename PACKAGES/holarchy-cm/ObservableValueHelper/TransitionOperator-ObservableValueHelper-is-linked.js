...
(function () {
  ...
  var operatorName = "".concat(cmLabel, " Is Linked");
  ...
  var operator = new holarchy.TransitionOperator({
    ...
    bodyFunction: function bodyFunction(operatorRequest_) {
      ...
      while (!inBreakScope) {
        inBreakScope = true;
        var messageBody = operatorRequest_.operatorRequest.holarchy.common.operators.ObservableValueHelper.isLinked; // Query the cell process step of the indicated ObservableValueHelper cell.
