...
require("./vector-set-cpm-process-operators"), require("./vector-set-cpm-shared-processes"), require("./vector-set-cpm-proxy-tests"), require("./vector-set-cmas-base-constructor"), require("./vector-set-cmas-base-a-vs-b-invariants")];