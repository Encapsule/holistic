...
# @encapsule/holodeck-assets v0.0.32 "jeunelanding"

```
Package: @encapsule/holodeck-assets v0.0.32 "jeunelanding" build ID "YF5kiOBrRUeb_lQwRnRuyg"
...
- [@encapsule/holodeck-assets Package Distribution](https://npmjs.com/package/@encapsule/holodeck-assets/v/0.0.32) ([@encapsule on npmjs.com](https://www.npmjs.com/org/encapsule))
