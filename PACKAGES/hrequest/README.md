...
# ![](ASSETS/encapsule-holistic-48x48.png)&nbsp;[Holistic App Platform](../../README.md#encapsule-project "Back to the Holistic App Platform README...") &bull; hrequest
...
```
Package: @encapsule/hrequest v0.0.33 "quatsino" build ID "P8D-x1lWQj2k9n8rhJpeRA"
...
The @encapsule/hrequest package is runtime library (RTL) package bundled in the @encapsule/holistic package for distribution via the `appgen` utility.

Once you have run `appgen` on your derived app/service git repo, `@encapsule/hrequest ` will be registered and available for [use](#usage) in your app/service implementation.
