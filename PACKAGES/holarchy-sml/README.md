...
# ![](ASSETS/encapsule-holistic-48x48.png)&nbsp;[Holistic App Platform](../../README.md#encapsule-project "Back to the Holistic App Platform README...") &bull; holarchy-sml
...
```
Package: @encapsule/holarchy-sml v0.0.33 "quatsino" build ID "P8D-x1lWQj2k9n8rhJpeRA"
...
The @encapsule/holarchy-sml package is runtime library (RTL) package bundled in the @encapsule/holistic package for distribution via the `appgen` utility.

Once you have run `appgen` on your derived app/service git repo, `@encapsule/holarchy-sml ` will be registered and available for [use](#usage) in your app/service implementation.
