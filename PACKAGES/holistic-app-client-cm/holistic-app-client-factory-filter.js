    ...
    bodyFunction: function bodyFunction(request_) {
      ...
      while (!inBreakScope) {
        ...
        var appClientCellModel = new holarchy.CellModel({
          ...
          name: "".concat(request_.name, " CellModel (synthesized)"),
          description: "Model description: ".concat(request_.description),
          apm: {
            // AbstractProcessModel declaration descriptor object
            id: request_.apmID,
            name: "".concat(request_.name, " AbtractProcessModel (synthesized)"),
            description: "Process description: ".concat(request_.description),
            ocdDataSpec: {
          ...
          {
            id: arccore.identifier.irut.fromReference("".concat(request_.cellModelID, "::holistic.app.client.lifecycle.initialize")).result,
