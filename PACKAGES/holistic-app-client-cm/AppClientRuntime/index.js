...
module.exports = new holarchy.CellModel({
  ...
  actions: [require("./ControllerAction-app-client-runtime-hook-events"), require("./ControllerAction-app-client-runtime-notify-event"), require("./ControllerAction-app-client-runtime-subprocess-create")],
