...
# ![](ASSETS/encapsule-holistic-32x32.png)&nbsp;Holistic App Platform v0.0.39 hakai-rc4
...
```
Package: @encapsule/holistic v0.0.39 "hakai-rc4" build ID "bszy1TUkShmy_VwVpKwfdw"
Sources: Encapsule/holistic-master#f70dd686926fca3a634fb501737e860bc2925198
Created: 2020-03-06T01:34:04.000Z Purpose: tools (Node.js) License: MIT
```
