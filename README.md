...
# ![](ASSETS/encapsule-holistic-32x32.png)&nbsp;Holistic App Platform v0.0.44 jasper-tr2-wip
...
```
Package: @encapsule/holistic v0.0.44 "jasper-tr2-wip" build ID "IDBSja7OR_OtLelNdLr6Og"
Sources: Encapsule/holistic-master#adea6b76a9a2e2eceea03ed96bbac8e83039fcab
Created: 2020-08-06T06:15:00.000Z Purpose: tools (Node.js) License: MIT
```
