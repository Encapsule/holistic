...
# ![](ASSETS/encapsule-holistic-32x32.png)&nbsp;Holistic App Platform v0.1.01 three-worlds
...
```
Package: @encapsule/holistic v0.1.01 "three-worlds" build ID "TCNhD7YWTgeNpM4_Jjaxwg"
Sources: @encapsule/holodev#6db877a5754b1e158dae50e50288c28e92a8e942
Created: 2021-05-11T18:24:18.000Z Purpose: tools (Node.js) License: MIT
```
