...
# ![](ASSETS/encapsule-holistic-32x32.png)&nbsp;Holistic App Platform v0.0.37 penroseisland
...
```
Package: @encapsule/holistic v0.0.37 "penroseisland" build ID "Q5KwHlXlQWOdrmnDsUtV5w"
Sources: Encapsule/holistic-master#5d59243bf785c6c3d3e2551a7e2a3ff92df88fdf
Created: 2020-02-19T22:16:04.000Z Purpose: tools (Node.js) License: MIT
```
